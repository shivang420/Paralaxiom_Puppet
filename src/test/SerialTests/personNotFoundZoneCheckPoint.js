...
beforeAll(async () => {
    ...
    await page.type('.card-body #inputAddress', PersonNotFoundZoneCheckPointName);

    await page.select('.card-body #inputState', "Person not found in the zone")
    ...
    await page.waitFor(200);
    await page.mouse.click(980, 330);
    await page.waitFor(200);
    await page.mouse.click(980, 680);
    await page.waitFor(200);
    await page.mouse.click(430, 680);
    await page.waitFor(200);
    await page.mouse.click(430, 330);
    await page.mouse.click(430, 330);
    ...
    await page.waitFor(2000);
    await page.screenshot({path: 'addingPersonNotFoundZoneCheckPoint.png'});
...
describe("Adding Person Not Found Zone CheckPoint", () => {
    test("Login", async () => {
        expect(this.loginCheckUrlCa).toBe("http://20.188.101.204/");
    }, timeout);

    test("Person Not Found Zone CheckPoint Added", async () => {
        expect(this.checkpointAdded).toBe(true);
    }, timeout);

    test("Person Not Found Zone CheckPoint Edited", async () => {
        expect(this.checkpointEdited).toBe(true);
    }, timeout);

    test("Person Not Found Zone CheckPoint Deleted", async () => {
