...
beforeAll(async () => {
    ...
    await page.type('.card-body #inputAddress', ZoneEntryCheckPointName);

    await page.select('.card-body #inputState', "Zone_Entry")
    ...
    await page.waitFor(200);
    await page.mouse.click(920, 270);
    await page.waitFor(200);
    await page.mouse.click(920, 620);
    await page.waitFor(200);
    await page.mouse.click(370, 620);
    await page.waitFor(200);
    await page.mouse.click(370, 270);
    await page.mouse.click(370, 270);
    ...
    await page.waitFor(2000);
    await page.screenshot({path: 'addingZoneEntryCheckPoint.png'});
...
describe("Adding Zone Entry CheckPoint", () => {
    test("Login", async () => {
        expect(this.loginCheckUrlCa).toBe("http://20.188.101.204/");
    }, timeout);
    
    test("Zone Entry CheckPoint Added", async () => {
        expect(this.checkpointAdded).toBe(true);
    }, timeout);

    test("Zone Entry CheckPoint Edited", async () => {
        expect(this.checkpointEdited).toBe(true);
    }, timeout);

    test("Zone Entry CheckPoint Deleted", async () => {
