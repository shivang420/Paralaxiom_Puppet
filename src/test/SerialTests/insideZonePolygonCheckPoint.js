...
beforeAll(async () => {
    ...
    await page.type('.card-body #inputAddress', InsideZonePolygonCheckPointName);
    ...
    await page.mouse.click(330, 230);
    await page.waitFor(200);
    await page.mouse.click(880, 230);
    await page.waitFor(200);
    await page.mouse.click(880, 580);
    await page.waitFor(200);
    await page.mouse.click(330, 580);
    await page.waitFor(200);
    await page.mouse.click(330, 230);
    await page.mouse.click(330, 230);
    ...
    await page.waitFor(2000);
    await page.screenshot({path: 'addingInsideZonePolygonCheckPoint.png'});
...
describe("Adding Inside Zone Polygon CheckPoint", () => {
    test("Login", async () => {
        expect(this.loginCheckUrlCa).toBe("http://20.188.101.204/");
    }, timeout);

    test("Inside Zone Polygon CheckPoint Added", async () => {
        expect(this.checkpointAdded).toBe(true);
    }, timeout);

    test("Inside Zone Polygon CheckPoint Edited", async () => {
        expect(this.checkpointEdited).toBe(true);
    }, timeout);

    test("Inside Zone Polygon CheckPoint Deleted", async () => {
